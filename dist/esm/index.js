...
var DynamicInput = function (_a) {
    ...
    return (React.createElement(Flex, { direction: "column" },
        type === FormFieldType$1.Boolean ? (React.createElement(SwitchField, { label: label, isChecked: inputValue, onChange: handleChange })) : null,
        (type === FormFieldType$1.Text || type === FormFieldType$1.Number) ? (React.createElement(React.Fragment, null,
            label && React.createElement(Text, null, label),
            React.createElement(Input, { value: inputValue, onChange: handleChange, placeholder: path, type: type, hasError: !!error }),
...
var DynamicForm = function (_a) {
    ...
    return (React.createElement(Flex, { direction: "column", gap: "1rem" },
...
var Dashboard = function (_a) {
    ...
    return (React.createElement(View, { as: "div", className: "dashboard-container" }, panels.map(function (panel) { return (React.createElement(Panel, { key: panel.id, id: panel.id, title: panel.title, minWidth: panel.minWidth, minHeight: panel.minHeight, location: panel.location }, panel.content)); })));
};
...
var DataTable = function (_a) {
    ...
    return (React.createElement("div", null,
        React.createElement(Button, { onClick: handleCreate }, "Create New Record"),
...
var OrderedList = function (_a) {
    ...
    var _c = useState(value.map(function (item, index) { return (__assign(__assign({}, item), { order: index })); })), items = _c[0], setItems = _c[1];
    var _d = useState(null), draggedIndex = _d[0], setDraggedIndex = _d[1];
...
export { Autocomplete, Chip, ColorSelection, Dashboard, DataTable, DynamicComponent, DynamicForm, DynamicInput, MenuLinks, Modal, MultiSelectField, OrderedList, Panel, Popover, SortableTable as Table };
